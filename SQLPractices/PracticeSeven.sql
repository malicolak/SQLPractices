...
--replacement_cost değerini ve karşılık gelen film sayısını getirir.
select replacement_cost, count(*) from film group by replacement_cost having count(*) > 50
--customer tablosunda bulunan store_id değerlerine karşılık gelen müşteri sayılarını getirir. 
select store_id, count(*) from customer group by store_id
--city tablosunda bulunan şehir verilerini country_id sütununa göre gruplandırdıktan sonra
--en fazla şehir sayısı barındıran country_id bilgisini ve şehir sayısını getirir.
